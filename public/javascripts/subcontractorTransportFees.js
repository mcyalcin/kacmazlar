...
$(document).ready(function () {
  $.getJSON('subcontractor_transport_fees/api/options', function(data) {
    editor = new $.fn.dataTable.Editor({
      ...
      ajax: "subcontractor_transport_fees/api",
      table: "#subcontractor_transport_fees",
      fields: [{
        label: "Firma:",
        name: "firm",
        type: "select",
        options: data.firmOptions,
        def: data.firmDef
      }, {
        label: "Ürün Cinsi:",
        name: "product",
    ...
    $('#subcontractor_transport_fees').dataTable({
